...
const date = new Date(this.props.videoInfo.timestamp)
      ...
      <div className="video__item--bigContainer">
        ...
        <div className="video_item--smallContainer">
          <div className="video_herotitle--wrapper">
            <span id="video__author">{this.props.videoInfo.channel}</span>
            <span className="video__date">{formatDate}</span>
          </div>

          <div className="video_herotitle--wrapper">
        <span className="video__numbers"><img src={Views} className="icon__position" />{this.props.videoInfo.views}</span>
            <span className="video__numbers"><img src={Likes} className="icon__position" />{this.props.videoInfo.likes}</span>
          </div>
        </div>
